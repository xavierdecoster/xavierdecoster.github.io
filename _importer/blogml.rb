...
module Jekyll
  ...
  module BlogML
    ...
    def self.process(source = "BlogML.xml")
      ...
      content = ""
	  blog_root = "http://www.xavierdecoster.com"
      ...
      File.open(".htaccess", "w") do |htaccess|	  
        ...
        doc.elements.each("blog/posts/post") do |item|
          ...
          content.gsub!(/\%2f/, "/")
          content.gsub!(/http:\/\/www.xavierdecoster.com/, "")  # remove the domain from my links and images
          content.gsub!(/http:\/\/xavierdecoster.com/, "")  # remove the domain from my links and images
          content.gsub!(/http:\/\/blog.xavierdecoster.com/, "")  # remove the domain from my links and images
